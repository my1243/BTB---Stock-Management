...
const Watchlist = () => {
    return(
        <>
            ...
            <div className="flex justify-between font-medium items-center py-1 px-2 bg-gray-200 rounded-lg mb-2">
            ...
            <div className="flex justify-between font-medium items-center py-1 px-2 bg-gray-200 rounded-lg">
                <div className="flex items-center">
