    ...
    return(
        <>
            ...
            <div className="flex flex-row justify-between items-center">
                ...
                <button onClick={postData} className={`w-8 h-8 my-1 mx-2 bg-gray-200 rounded-full transition-all duration-150 ease-in ${isFavourite ? 'text-red-500 hover:text-black' : 'text-black hover:text-red-500'}`}><i class="fa-solid fa-heart"></i></button>
            </div>
